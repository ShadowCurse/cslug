...
vec2 slug_dialate(vec4 pos, vec4 tex, vec4 jac, vec4 m0, vec4 m1, vec4 m3, vec2 dim, out vec2 vpos) {
...
void main() {
    ...
    v_texcoord = slug_dialate(in_pos, in_tex, in_jac, transform[0], transform[1], transform[3], screen_size, p);
